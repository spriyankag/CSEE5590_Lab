...
def fetch_words_data(url=data_url, words_data=data_dir):
    ...
    # Path to zip file 
    zip_path = os.path.join(words_data, r"C:\Users\mural\Downloads\DeepLearning_Lesson3\DeepLearning_Lesson3\Word2Vec\data\words.zip")
...
with tf.Session() as sess:
    ...
    writer = tf.summary.FileWriter('./graphs1/words', sess.graph)
    sess.run(init)
    average_loss = 0
