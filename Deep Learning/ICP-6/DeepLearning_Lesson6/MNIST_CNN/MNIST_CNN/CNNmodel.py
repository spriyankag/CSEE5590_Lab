...
#changed the data set and stored in data variable
...
#used 4 different optimizers, changed learning rate from3 to 1
...
#train_step = tf.train.RMSPropOptimizer(1e-1).minimize(cross_entropy)
